...
const Notification = () => {
  ...
  const fetchNotificationData = async () => {
    await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/notification`, { withCredentials: true }).then(res => {
  ...
  const handleOnClickNotification = async (item) => {
    await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/notification/isRead`, { notificationId: item._id }, { withCredentials: true }).then(res => {
