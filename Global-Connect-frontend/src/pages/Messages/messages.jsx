...
const Messages = () => {
    ...
    const fetchMessages = async () => {
        await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/message/${activeConvId}`,{ withCredentials: true }).then(res => {
            console.log(res)
    ...
    const fetchConversationOnLoad = async () => {
        await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/conversation/get-conversation`, { withCredentials: true }).then(res => {
    ...
    const handleSendMessaeg = async () => {
        await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/message`, { conversation: activeConvId, message: messageText, picture: imageLink }, { withCredentials: true }).then(res => {
