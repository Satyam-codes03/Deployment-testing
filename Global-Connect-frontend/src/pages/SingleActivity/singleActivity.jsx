...
const SingleActivity = () => {
    ...
    const fetchDataOnLoad = async () => {
        try {
            ...
            console.log('Attempting API call to:', `${import.meta.env.VITE_BACKEND_URL}/api/post/getPostById/${postId}`);
            ...
            const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/post/getPostById/${postId}`);
